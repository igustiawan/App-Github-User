...
public class FollowersViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<UserModel>> listFollowers = new MutableLiveData<>();
    private static final String API_KEY = BuildConfig.API_KEY;

    public void setUserFollowers(final String username){
    ...
    public LiveData<ArrayList<UserModel>> getListFollowers() {
